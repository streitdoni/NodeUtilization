...
#include "../QoS/QoSRequirementsMapping.h"
...
protected:
    ...
    std::vector<double> singleHopTranmissionTimes;
...
//    double* determineUtilization();
    double determineQoSRREQTreatment(double requiredBandwidth, double requiredSlotTime, simtime_t singleHopTransmissionTime);
