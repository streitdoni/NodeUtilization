//
// Generated file, do not edit! Created by nedtool 5.4 from src/routing/AODVQoS/AODVQoSControlPackets.msg.
//
...
void AODVQoSRREQ::copy(const AODVQoSRREQ& other)
{
    ...
    this->oneHopTransmissionTime = other.oneHopTransmissionTime;
}
...
void AODVQoSRREQ::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->oneHopTransmissionTime);
}
...
void AODVQoSRREQ::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->oneHopTransmissionTime);
}
...
::omnetpp::simtime_t AODVQoSRREQ::getOneHopTransmissionTime() const
{
    return this->oneHopTransmissionTime;
}

void AODVQoSRREQ::setOneHopTransmissionTime(::omnetpp::simtime_t oneHopTransmissionTime)
{
    this->oneHopTransmissionTime = oneHopTransmissionTime;
}
...
int AODVQoSRREQDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='o' && strcmp(fieldName, "oneHopTransmissionTime")==0) return base+13;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
std::string AODVQoSRREQDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 13: return simtime2string(pp->getOneHopTransmissionTime());
        default: return "";
    }
}
...
bool AODVQoSRREQDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 13: pp->setOneHopTransmissionTime(string2simtime(value)); return true;
        default: return false;
    }
}
