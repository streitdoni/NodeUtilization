...
#ifndef __INET_AODVStandardRouting_H
#define __INET_AODVStandardRouting_H
...
#include "AODVStandardRouteData.h"
...
class AODVStandardRouting : public cSimpleModule, public ILifecycle, public INetfilter::IHook, public cListener
{
...
protected:
    ...
    AODVStandardRREPACK *createRREPACK();
    AODVStandardRREP *createHelloMessage();
    AODVStandardRREQ *createRREQ(const L3Address& destAddr);
    AODVStandardRREP *createRREP(AODVStandardRREQ *rreq, IRoute *destRoute, IRoute *originatorRoute, const L3Address& sourceAddr);
    AODVStandardRREP *createGratuitousRREP(AODVStandardRREQ *rreq, IRoute *originatorRoute);
    AODVStandardRERR *createRERR(const std::vector<StandardUnreachableNode>& unreachableNodes);

    /* Control Packet handlers */
    void handleRREP(AODVStandardRREP *rrep, const L3Address& sourceAddr);
    void handleRREQ(AODVStandardRREQ *rreq, const L3Address& sourceAddr, unsigned int timeToLive);
    void handleRERR(AODVStandardRERR *rerr, const L3Address& sourceAddr);
    void handleHelloMessage(AODVStandardRREP *helloMessage);
    void handleRREPACK(AODVStandardRREPACK *rrepACK, const L3Address& neighborAddr);

    /* Control Packet sender methods */
    void sendRREQ(AODVStandardRREQ *rreq, const L3Address& destAddr, unsigned int timeToLive);
    void sendRREPACK(AODVStandardRREPACK *rrepACK, const L3Address& destAddr);
    void sendRREP(AODVStandardRREP *rrep, const L3Address& destAddr, unsigned int timeToLive);
    void sendGRREP(AODVStandardRREP *grrep, const L3Address& destAddr, unsigned int timeToLive);

    /* Control Packet forwarders */
    void forwardRREP(AODVStandardRREP *rrep, const L3Address& destAddr, unsigned int timeToLive);
    void forwardRREQ(AODVStandardRREQ *rreq, unsigned int timeToLive);
    ...
    void sendAODVPacket(AODVStandardControlPacket *packet, const L3Address& destAddr, unsigned int timeToLive, double delay);
    void clearState();
...
public:
    AODVStandardRouting();
    virtual ~AODVStandardRouting();
};

 // namespace inet

#endif    // ifndef AODVSTANDARDRouting_H_
